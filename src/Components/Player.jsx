...
const Player = () => {
  ...
  useEffect(() => {
    if (selectedSong) {
      const seletedSongIndex = songs.data.findIndex((song) => song.id === selectedSong.id);
  ...
  return (
    <div className="player-container">
      ...
      <img src={`https://cms.samespace.com/assets/${songs.data[currentSong].cover}`} alt="Viva La Vida" />
      <div className="player-controls">
        ...
        <div className="all-controls">
          ...
          <div onClick={toggleMute} className="sound">{isMuted ? <HiSpeakerXMark /> : <HiSpeakerWave />}</div>
        </div>
      </div>
    </div>
  );
